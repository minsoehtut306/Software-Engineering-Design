...
public class DataSetTest {
    ...
    @Test
    @DisplayName("Test printSummaryStatistics runs without exceptions")
    void testPrintSummaryStatisticsRuns() {
    File validFile = RESOURCE_PATH.resolve("validDataset.csv").toFile();
    dataset.setDataSet(validFile.getAbsolutePath());

    assertDoesNotThrow(() -> dataset.printSummaryStatistics(),
        "printSummaryStatistics should run without throwing exceptions.");
    }
